<template>
    <header class="flex-space flex">
        ...
        <div class="tab-item" :class="{ active: urlRouter == '/waitpay' }">
            <router-link to="./waitpay"> <p class="tab-title">待付款</p> </router-link>
        </div>
        <div class="tab-item" :class="{ active: urlRouter == '/waitdeliver' }">
            <router-link to="./waitdeliver"> <p class="tab-title">待发货</p> </router-link>
        </div>
        <div class="tab-item" :class="{ active: urlRouter == '/waitreceive' }">
            <router-link to="./waitreceive"> <p class="tab-title">待收货</p> </router-link>
        </div>
        <div class="tab-item" :class="{ active: urlRouter == '/orderdown' }">
            <router-link to="./orderdown"> <p class="tab-title">已完成</p> </router-link>
        </div>
    </header>
</template>
